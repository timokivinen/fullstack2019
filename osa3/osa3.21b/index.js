// --------------------------------------------------------------------------
// --- Tehtävä:         3.21 tietokantaa käyttävä versio internettiin
// --- Pvm:             3.9.2019 Timo Kivinen
// ---                  Backend, Frontend = 3.20f
// --- Aikaa käytetty:  x h
// --------------------------------------------------------------------------
// --- 1) Procfile      web: node index.js
// --- 2) const PORT = process.env.PORT || 3001
// --- 3) Git install:	   .gitignore  node_modules
// ---                      git init, git add, git commit 
// --- 4) Heroku            heroku create, git push heroku master
// --- 5) Test Heroku page: https://shielded-springs-95887.herokuapp.com/api/persons
// ---                    
// ---                      heroku logs -t
// --------------------------------------------------------------------------
// --- Plug ins:            JSONview
...
// --- Validator:           npm install --save mongoose-unique-validator
...
app.post('/api/persons', (req, res, next) => {
  console.log(`----------------------------------  APP.POST ADD 1`)
  // ----------------------------------------------------------
  // --- Duplikaatti-validaattori: person.js        (Teht3.19)
  // ----------------------------------------------------------
  ...
  app.put('/api/persons/:id', (req, res, next) => {
    ...
    // --- Validoidaan ja päivitetään puhelinnumero
    const person = new Person({
      number: req.body.number
    })
    Person.findById(modelId)
      .then((person) => {
  ...
  // --------------------------------------------------------------------
  // --- virheellisten pyyntöjen käsittely (Teht. 3.16/3.19)
  // --------------------------------------------------------------------
